...
const FocusTimer: React.FC<FocusTimerProps> = ({ onSessionComplete }) => {
  ...
  return (
    <Card className="card-interactive">
      <CardHeader>
        <CardTitle className="text-gradient-primary flex justify-between w-full">
          <span>{isBreak ? 'Break Time' : 'Focus Session'}</span>
          <Button 
            variant="ghost" 
            size="sm" 
            onClick={() => setShowSettings(!showSettings)}
            className="h-7 w-7 p-0 btn-enhanced"
          >
      ...
      <CardContent className="flex flex-col items-center">
        {showSettings ? (
          <div className="w-full space-y-4 mb-4 stagger-fade-in">
            ...
            <Button onClick={saveDefaultSettings} className="w-full btn-enhanced">
          ...
          <div className="stagger-fade-in">
            ...
            <div className="flex space-x-2">
              <Button 
                ...
                variant="outline"
                size="icon"
                className="h-10 w-10 rounded-full btn-enhanced"
              >
