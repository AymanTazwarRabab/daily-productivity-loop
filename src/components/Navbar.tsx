...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-background/80 backdrop-blur-md border-t border-border/50 p-2 md:p-0 md:top-0 md:bottom-auto md:border-t-0 md:border-b z-10 transition-all duration-300">
          ...
          <Link key={item.path} to={item.path}>
            ...
            >
              <item.icon className={`
                ...
                ${isActive(item.path) ? 'animate-bounce text-primary' : ''}
              `} />
